...
/**
 * @brief Utilizzando questo metodo posso cofigurare e lanciare la simulazione, 
 *        decidere quanti nodi fanno parte della simulazione e le loro caratteristiche
 * @param evt
 */
...
/**
 * Questo metodo permette di selezionare un file di input per leggere la configurazione della simulazione
 * @param evt
 */
private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
    ...
    catch(Exception e){System.out.println("Eccezzione\n");e.printStackTrace();}
...
// TODO add your handling code here:
    ...
    private nodo_hap generaHap(scheduler s,int id_nodo,Grafo g,NodoSatellite sat,canale hapSat,double capacita,double dim_pacchetto,double tempo_propagazione) {
        ...
        nodo_hap h1 = new nodo_hap(s,id_nodo,pl,ll,nl,g,sat,hapSat,capacita,dim_pacchetto,tempo_propagazione);
        return h1;
    }
    ...
    private void leggiIlFileXML(String path) {
        ...
        satObject.clear();hapObject.clear();nodeObject.clear();allNode.clear();    
        this.oggettiStatistici.clear();   
        //Creo il Simulation Scheduler
        double max_time = Double.valueOf(orizons.getText()).doubleValue()*60000;
        Vector<appartenenzaHostNodi> app = new Vector<appartenenzaHostNodi>();
        ...
        while(iterator.hasNext()){
            ...
            while(i.hasNext()){
                ...
                for(int j=0;j<=id_spot;j++){
                    ...
                    else canaleUpLinkSatellite_it.next();
                }
            ...
            while(igrafo.hasNext()){
                ...
                while(iLink.hasNext()){
                    ...
                    if(tipoLink.equals("full")){
                        ...
                        lista.add(costo);lista.add(delay);lista.add(banda);
                        l.setPesi(lista);
    ...
    /**
     * Questo metodo viene utilizzato per trovare un oggetto partendo dal suo ID, lo uso
     * quando devo generare gli eventi da aggiungere allo scheduler
     * @param id_nodo
     * @param allNode
     * @return
     */
